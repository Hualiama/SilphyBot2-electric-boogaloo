...
class GateCommands(BaseCog):
    @commands.command(name="gatelock", brief="[A] Prevent users from passing the gate", description="Toggles the lock on the gate, allowing one to turn off the auto-role feature.")
